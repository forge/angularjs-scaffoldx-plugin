...
{
   /**
    * Get the {@link DirectoryResource} representing the directory this {@link Project} uses to store templates across all 
    * scaffold providers.
    */
   ...
   /**
    * At the given path/filename relative to the scaffold provider specific directory under the project templates directory:
    * {@link #getTemplateDirectory()} - create a file containing the given bytes.
    * 
    * The provider name cannot be null.
    * 
    * @return a handle to the {@link FileResource} that was created.
    */
   FileResource<?> createResource(char[] bytes, String provider, String relativeFilename);
