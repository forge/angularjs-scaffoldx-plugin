package org.jboss.forge.scaffold.angularjs.scenario.dronetests.singleentitywithenum;
...
@RunAsClient
public class CustomerWithPaymentTypeViewClient {
    ...
    public void testSaveNewCustomer(@ArquillianResource URL baseUrl) throws Exception {
        ...
        WebElement paymentTypeElement = driver.findElement(By.id("paymentType"));
        Select paymentType = new Select(paymentTypeElement);
        paymentType.selectByVisibleText("CREDIT_CARD");
        ...
        paymentTypeElement = driver.findElement(By.id("paymentType"));
        paymentType = new Select(paymentTypeElement);
        assertEquals("CREDIT_CARD", paymentType.getFirstSelectedOption().getText());
        ...
        paymentTypeElement = driver.findElement(By.id("paymentType"));
        paymentType = new Select(paymentTypeElement);
        assertEquals("Choose a Payment Type", paymentType.getFirstSelectedOption().getText());
    }
