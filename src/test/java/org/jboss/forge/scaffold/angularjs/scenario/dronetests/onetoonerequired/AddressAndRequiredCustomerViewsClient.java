package org.jboss.forge.scaffold.angularjs.scenario.dronetests.onetoonerequired;
...
@RunAsClient
public class AddressAndRequiredCustomerViewsClient {
    ...
    public void testSaveNewAddress(@ArquillianResource URL baseUrl) throws Exception {
        ...
        assertEquals(baseUrl.toString() + "app.html#/Addresss/edit/1", driver.getCurrentUrl());
    ...
    public void testSaveNewCustomer(@ArquillianResource URL baseUrl) throws Exception {
        ...
        // Verify that the shipping Address field is marked as required before filling
        isBootstrapErrorDisplayedForFormControl("shippingAddressControls","required");
        
        // Establish the customer and address relationship
        ...
        assertEquals(baseUrl.toString() + "app.html#/Customers/edit/2", driver.getCurrentUrl());
